    ...
    _timer = new Timer.periodic(const Duration(seconds: 1), (Timer timer) {
      ...
      if (_start < 1) {
        ...
        _pageController.animateToPage(
            _pageController.page == 2.0 ? 0 : _pageController.page.toInt() + 1,
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            _sectionSubjectTitle('Programming NewCovid-19'),
            Padding(
              padding: const EdgeInsets.fromLTRB(6.0, 6, 6, 12),
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: programmingSection
                      .map((data) => _programSectionRowItem(data, size))
                      .toList()),
            ),
            Container(
              width: size.width,
            ...
            Container(
              ...
              child: ListView(
                  ...
                  children: popularMaterialsHorizontalList
                      .map(_popularMaterialsItem)
                      .toList()),
            ),
          ],
        ),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Padding(
                  padding:
                      EdgeInsets.all(data.imageName == 'covid.png' ? 12 : 8.0),
                  child: Container(
                      width: data.imageName == 'covid.png' ? 54 : 60,
                      height: data.imageName == 'covid.png' ? 54 : 60,
                      child: Image.asset('images/${data.imageName}')),
                ),
                Padding(
