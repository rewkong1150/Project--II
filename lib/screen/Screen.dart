import 'package:GoogleMaps/News-covid/main.dart';
import 'package:GoogleMaps/chat/pages/root.dart';
import 'package:GoogleMaps/chat2/main.dart';
...
import '../cecendaui.dart';
import '../cotact hot.dart';
import '../found.dart';
import '../login.dart';
import '../map.dart';
import '../test.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Image.asset('assets/colse2.png', width: 25),
          onPressed: () {
                        ...
                        children: [
                          ...
                          Container(
                            child: FlatButton(
                              ...
                              child: regularCard(
                                  'assets/virus.svg', 'จำนวนติดเชื่อ(จังหวัด)'),
                            ),
                          ),
                          Container(
                            child: FlatButton(
                        ...
                        children: [
                          Container(
                            child: FlatButton(
                              ...
                              child: regularCard('assets/trend.svg', 'ข่าวสาร'),
                            ),
                          ),
                          Container(
                            child: FlatButton(
